...
from app.routers import health, auth, operations, admin, tasks, trucks, vessels, bdns, truck_bdns, notifications, pfis, documents, analytics, portal, invoices, vouchers, vessel_activities, licences, vessel_bdns, client_notifications, kpi, terminal_receipts
...
app.include_router(truck_bdns.router, prefix=API_PREFIX)
